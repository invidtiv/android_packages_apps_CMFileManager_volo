...
public enum FileManagerSettings {
        ...
        /**
         * When to editor should use the default color scheme of the theme for syntax
         * highlight
         * 
         * @hide
         */
         ...
         * A broadcast intent that is sent when a setting was changed
         */
        public final static String INTENT_SETTING_CHANGED = com.cyanogenmod.filemanager.BuildConfig.APPLICATION_ID
                        + ".INTENT_SETTING_CHANGED"; //$NON-NLS-1$

        /**
         * A broadcast intent that is sent when a theme was changed
         */
        public final static String INTENT_THEME_CHANGED = com.cyanogenmod.filemanager.BuildConfig.APPLICATION_ID
                        + ".INTENT_THEME_CHANGED"; //$NON-NLS-1$

        /**
         * A broadcast intent that is sent when a setting was changed
         */
        public final static String INTENT_MOUNT_STATUS_CHANGED = com.cyanogenmod.filemanager.BuildConfig.APPLICATION_ID
                        + ".INTENT_MOUNT_STATUS_CHANGED"; //$NON-NLS-1$

        /**
         * A broadcast intent that is sent when a file was changed
         */
        public final static String INTENT_FILE_CHANGED = com.cyanogenmod.filemanager.BuildConfig.APPLICATION_ID
                        + ".INTENT_FILE_CHANGED"; //$NON-NLS-1$

        /**
         * Intent action to set the home directory
         */
        public final static String INTENT_SET_HOME = com.cyanogenmod.filemanager.BuildConfig.APPLICATION_ID
                        + ".ACTION_SET_HOME"; //$NON-NLS-1$
